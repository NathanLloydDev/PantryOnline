...
namespace PantryOnline.Controllers
{
    public class IngredientsController : Controller
    {
        ...
        public IngredientsController(PantryOnlineContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,CostPer100g,WeightPerUnit")] Ingredient ingredient)
        {
            if (id != ingredient.ID)
            {
                return NotFound();
