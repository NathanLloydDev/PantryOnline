...
namespace PantryOnline.Controllers
{
    public class RecipesController : Controller
    {
        ...
        public RecipesController(PantryOnlineContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,PageNumber,MakeAhead,LongerRecipe,GoodToFreeze,IngredientsComplete,StepsComplete")] Recipe recipe)
        {
            if (id != recipe.ID)
            {
                return NotFound();
